//
//  SocialConnectionStatsView.swift
//  Amped
//
    ...
    var body: some View {
        ...
        .overlay(content: {
            BottomSheet(isPresented: $showSheet) {
                MetricImpactSheetContent(metricType: .socialConnectionsQuality, customTitle: "Impact score: Social Connections")
            }
        })
